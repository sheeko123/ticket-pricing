...
def analyze_price_distribution(df):
    ...
    plt.tight_layout()
    plt.savefig('graphs/price_analysis_stratified.png')
    print("Saved price analysis visualizations to 'graphs/price_analysis_stratified.png'")
...
def build_glm_model_stratified(df_model, model_type='tweedie'):
    """
    Build and evaluate GLM model with stratified grouped cross-validation
    """
    print(f"\nBuilding GLM model with {model_type} distribution using stratified grouped cross-validation...")
    ...
    plt.tight_layout()
    plt.savefig(f'graphs/price_prediction_{model_type}_stratified.png')
    print(f"Saved price prediction plot to 'graphs/price_prediction_{model_type}_stratified.png'")
...
def main():
    ...
    gamma_results_floor, X_test_floor, y_test_floor = build_glm_model_stratified(df_model_floor, model_type='gamma')
    tweedie_results_floor, _, _ = build_glm_model_stratified(df_model_floor, model_type='tweedie')
    ...
    gamma_results_non_floor, X_test_non_floor, y_test_non_floor = build_glm_model_stratified(df_model_non_floor, model_type='gamma')
    tweedie_results_non_floor, _, _ = build_glm_model_stratified(df_model_non_floor, model_type='tweedie')
