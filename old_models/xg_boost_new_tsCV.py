...
def build_xgboost_model_tscv(df_model):
    """
    Build and evaluate XGBoost model with time series cross-validation
    """
    print("\nBuilding XGBoost model with time series cross-validation...")
    ...
    plt.tight_layout()
    plt.savefig('feature_importance_tscv.png')
    print("Saved feature importance plot to 'feature_importance_tscv.png'")
    ...
    plt.tight_layout()
    plt.savefig('price_prediction_xgboost_tscv.png')
    print("Saved price prediction plot to 'price_prediction_xgboost_tscv.png'")
