...
def analyze_price_distribution(df):
    ...
    plt.tight_layout()
    plt.savefig('price_analysis_new.png')
    print("Saved price analysis visualizations to 'price_analysis_new.png'")
...
def build_glm_model(df_model, model_type='tweedie'):
    ...
    plt.tight_layout()
    plt.savefig(f'price_prediction_{model_type}_new.png')
    print(f"Saved price prediction plot to 'price_prediction_{model_type}_new.png'")
...
def main():
    ...
    gamma_results_floor, X_test_floor, y_test_floor = build_glm_model(df_model_floor, model_type='gamma')
    tweedie_results_floor, _, _ = build_glm_model(df_model_floor, model_type='tweedie')
    ...
    gamma_results_non_floor, X_test_non_floor, y_test_non_floor = build_glm_model(df_model_non_floor, model_type='gamma')
    tweedie_results_non_floor, _, _ = build_glm_model(df_model_non_floor, model_type='tweedie')
