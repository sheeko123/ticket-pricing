...
def build_xgboost_model_groupcv(df_model):
    """
    Build and evaluate XGBoost model with grouped cross-validation
    """
    print("\nBuilding XGBoost model with grouped cross-validation...")
    ...
    plt.tight_layout()
    plt.savefig('graphs/feature_importance_groupcv.png')
    print("Saved feature importance plot to 'graphs/feature_importance_groupcv.png'")
    ...
    plt.tight_layout()
    plt.savefig('graphs/price_prediction_xgboost_groupcv.png')
    print("Saved price prediction plot to 'graphs/price_prediction_xgboost_groupcv.png'")
